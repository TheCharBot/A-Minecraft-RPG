...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(images.player_idle_down).convert_alpha()
    ...
    def update(self, dt):
        ...
        for rect in interact_rects:
            if self.rect.colliderect(rect) and self.facing == npc.interact_direction and self.x_pressed == True:
    ...
    def animate(self, animationState):
        ...
        if is_even(animationState) and self.anim_on == True:
