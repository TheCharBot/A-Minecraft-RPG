    ...
    def animate(self, animationState):
        ...
        if config.is_even(animationState) and self.anim_on == True:
            if self.facing == "right":
                self.image = images.image_cache.get_image("player_right_1")
            elif self.facing == "left":
                self.image = images.image_cache.get_image("player_left_1")
            elif self.facing == "up":
                self.image = images.image_cache.get_image("player_up_1")
            elif self.facing == "down":
                self.image = images.image_cache.get_image("player_down_1")
            
        # If the animation state is odd, do a different animation
        else:
            if self.facing == "right":
                self.image = images.image_cache.get_image("player_right_2")
            elif self.facing == "left":
                self.image = images.image_cache.get_image("player_left_2")
            elif self.facing == "up":
                self.image = images.image_cache.get_image("player_up_2")
            elif self.facing == "down":
                self.image = images.image_cache.get_image("player_down_2")
