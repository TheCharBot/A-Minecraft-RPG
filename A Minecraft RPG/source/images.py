...
### PLAYER IMAGES ###
player_idle_down = os.path.join("textures", "player", "idle", "idle_down.png")
player_idle_up = os.path.join("textures", "player", "idle", "idle_up.png")
player_idle_left = os.path.join("textures", "player", "idle", "idle_left.png")
player_idle_right = os.path.join("textures", "player", "idle", "idle_right.png")
